################################################################################
##   SpliceosomeAtlas — Pan-cancer alteration landscape of the core spliceosome machinery
...
##   GitHub : https://github.com/siddugayam/SpliceosomeAtlas
...
GENE_ORDER    <- c("SF3B1", "SF3A1", "U2AF1", "U2AF2", "ZRSR2", "PHF5A", "SUGP1", "PRPF8", "LUC7L2", "SRSF2", "RBM39", "RBM10", "HNRNPK", "FUBP1", "DDX3X")
GENE_CATEGORY <- c("SF3B1"="U2 snRNP / 3′SS", "SF3A1"="U2 snRNP / 3′SS", "U2AF1"="U2 snRNP / 3′SS", "U2AF2"="U2 snRNP / 3′SS", "ZRSR2"="U2 snRNP / 3′SS", "PHF5A"="U2 snRNP / 3′SS", "SUGP1"="U2 snRNP / 3′SS", "PRPF8"="U5 / core", "LUC7L2"="U5 / core", "SRSF2"="SR proteins", "RBM39"="SR proteins", "RBM10"="Regulators / hnRNP", "HNRNPK"="Regulators / hnRNP", "FUBP1"="Regulators / hnRNP", "DDX3X"="Regulators / hnRNP")
CAT_COLORS    <- c("U2 snRNP / 3′SS"="#534AB7", "U5 / core"="#1D9E75", "SR proteins"="#D85A30", "Regulators / hnRNP"="#185FA5")
...
combined <- (fig2 | fig4) / (fig3 + theme(plot.margin = unit(c(0,1,0,0),"cm"))) +
  ...
  plot_annotation(title = "SpliceosomeAtlas: Pan-cancer alteration landscape of the core spliceosome machinery",
    subtitle = paste0("TCGA PanCancer Atlas 2018 - ", NGENES, " genes - 32 tumour types - n = 10,195"),
    caption = "Data: cBioPortal public API - github.com/siddugayam/SpliceosomeAtlas",
