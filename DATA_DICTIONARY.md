# Data Dictionary — SpliceosomeAtlas

**Dataset:** core spliceosome / splicing-factor gene alterations across the TCGA PanCancer Atlas (32 tumour types, n = 10,195).
**Source:** cBioPortal public REST API (v7.0.0, retrieved June 2026). **Genes (15):** SF3B1, SF3A1, U2AF1, U2AF2, SRSF2, ZRSR2, RBM10, PRPF8, LUC7L2, DDX3X, SUGP1, PHF5A, RBM39, HNRNPK, FUBP1.
...
## 1. `tcga_pancan_spliceosome_alteration_freqs_long.csv` — master long table (480 rows × 23 cols)
...
## 5. `spliceosome_gene_rank_summary.csv` (15 rows × 9 cols)
...
## 6. `spliceosome_top5_tumours_per_gene.csv` (75 rows × 9 cols)
`geneSymbol`, `rank` (1–5), `tumour_acronym`, `N`, `any_alter_freq`, `mut_freq`, `any_cna_freq`, `amp_freq`, `deep_del_freq`.

## 7. `spliceosome_tumour_burden_ranking.csv` (32 rows × 7 cols)
...
## 8. `brca_spliceosome_alteration_frequencies.csv` (15 rows × 15 cols; N = 1052)
...
## 10. `tcga_low_coverage_tumours_for_spliceosome.txt`
